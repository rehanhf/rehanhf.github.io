...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen text-white selection:bg-neon/30 selection:text-white cursor-none">
      <MouseFollower />
      <Background />
      <Navbar />

      {/* RH. Logo - Fixed in corner below navbar logic */}
      <div className="fixed top-6 left-6 md:left-10 z-50 pointer-events-none mix-blend-difference">
        <h1 className="text-2xl font-black tracking-tighter text-white font-sans">RH.</h1>
      </div>

      <main className="max-w-screen-xl px-6 mx-auto pt-32 md:pt-40">
        
        {/* Hero Section */}
        <section id="home" className="min-h-[70vh] flex flex-col md:flex-row items-center gap-12 md:gap-0 mb-20">
        ...
        {/* Skills & Currently Learning Block */}
        <section id="expertise" className="py-20 border-t border-white/5">
             <div className="mb-10">
